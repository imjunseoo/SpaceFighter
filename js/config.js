...
const SKILL_POOL = [
    ...
    // ── Gold ────────────────────────────────────────────────
    { id: 'exp_boost', grade: 'gold', name: '데이터 수집 가속', icon: '📈', desc: '경험치 획득량 <span class="highlight">+30%</span> 증가.', unique: true },
...
const ARTIFACT_POOL = [
    ...
    },
    {
        ...
        name: '아론다이트', icon: '🔱',
        desc: '(Z) 2단 단계 콤보. <span class="highlight">200%×2</span> 대미지.',
        attack: { type: 'cross_combo', damageRatio: 2.0, range: 240, cooldown: 28 }
    },
    {
        id: 'excalibur', tier: 4, category: 'weapon',
        name: '엑스칼리버', icon: '✨',
        desc: '(Z) 3단 콤보. 1·2단 십자가 후 화면 전체 참격. <span class="highlight"></span>',
    ...
    },
    {
        ...
        name: '폭발 수리검', icon: '💥',
        desc: '(자동) 강력한 투사체 자동 발사. <span class="highlight">70%</span> 범위 피해.',
    ...
    },
    {
        ...
        name: '군용 드론', icon: '⚙️',
        desc: '(드론) 사거리 내 복수의 적에게 융단 포격 발사. <span class="highlight">70%</span> 대미지.<br><span class="highlight">중복 획득 시 드론 1대 증설 (최대 5대).</span>',
